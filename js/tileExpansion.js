...
// Character-aware expansion maps for MECH_ARM tiles (broken arm landmark)
// Preserves the arm's visual appearance at higher zoom levels
const MECH_ARM_CHAR_2x2 = {
  '\u2588': [['\u2588','\u2588'],['\u2588','\u2588']],         // █ → solid block
  '\u2593': [['\u2593','\u2588'],['\u2588','\u2593']],         // ▓ → textured shade
  '\u2592': [['\u2592','\u2593'],['\u2593','\u2592']],         // ▒ → medium shade
  '\u2591': [['\u2591','\u2592'],['\u2592','\u2591']],         // ░ → light shade
...
function _expandTileInner(tile, density, wx, wy) {
  ...
  if (tile.type === 'MECH_ARM') {
    const charMap = density === 2 ? MECH_ARM_CHAR_2x2 : MECH_ARM_CHAR_3x3;
